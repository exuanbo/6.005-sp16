...
public class TurtleSoup {
     ...
     * <p>
     * HINT: look at <a href="http://en.wikipedia.org/wiki/Atan2">atan2 - Wikipedia</a> and Java's math libraries
     *
    ...
    public static double calculateHeadingToPoint(double currentHeading, int currentX, int currentY,
        ...
        double targetAngle = Math.atan2(targetY - currentY, targetX - currentX) / Math.PI * 180;
        double adjustment = -currentHeading + 90 - targetAngle;
        return (adjustment + 360) % 360;
    }
